<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="Platinum Earrings.aspx.cs" Inherits="USER_Platinum_Earrings" Title="Untitled Page" %>
    ...
    <table align="center" cellpadding="3" cellspacing="4" class="style6">
        <tr>
            <td colspan="2">
                ...
                ImageUrl="~/images/pla earing/earring_4.jpg" Width="100%" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
