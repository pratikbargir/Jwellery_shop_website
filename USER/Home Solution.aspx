<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="Home Solution.aspx.cs" Inherits="USER_Home_Solution" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <P align="center" style="font-family: Arial, Helvetica, sans-serif; font-size: x-large; color: #FF00FF">Home Solution</P>
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="pid" DataSourceID="AccessDataSource1" 
        ...
        <ItemTemplate>
            <table cellpadding="7" cellspacing="8" class="style2">
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        Resolvation:<asp:Label ID="Label3" runat="server" 
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="6" Name="pcategorey" Type="String" />
        </SelectParameters>
