<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="Hiden cameras.aspx.cs" Inherits="USER_Hiden_cameras" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p align="center" style="font-family: Arial, Helvetica, sans-serif; font-size: x-large; color: #FF00FF">Hidden Cameras</p>
            ...
            <table cellpadding="5" cellspacing="7" class="style2">
                ...
                <tr>
                    <td rowspan="6" style="text-align: center">
                        <asp:ImageButton ID="ImageButton1" runat="server" Height="200px" 
                            ImageUrl='<%# Eval("pphoto") %>' onclick="ImageButton1_Click" Width="200px" />
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="2" style="text-align: center">
                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Mm/580b57fcd9996e24bc43c465.png" 
                            Width="200px" Height="100px"
                            style="text-align: center" onclick="ImageButton2_Click" 
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="4" Name="pcategorey" Type="String" />
        </SelectParameters>
