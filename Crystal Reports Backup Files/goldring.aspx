<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="goldring.aspx.cs" Inherits="USER_Gold_goldring" Title="Untitled Page" %>
    ...
    <tr>
        <td colspan="2">
            <asp:Image ID="Image1" runat="server" Height="150px" 
                ImageUrl="~/images/gold ring/ring_1.png" Width="100%" />
        </td>
    </tr>
    <tr>
        <td colspan="2">
