<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="Diamond ring.aspx.cs" Inherits="USER_Diamond_ring" Title="Untitled Page" %>
    ...
    <table align="center" cellpadding="3" cellspacing="4" class="style6">
        <tr>
            <td colspan="2">
                ...
                ImageUrl="~/images/dia ring/ring_7.jpg" Width="100%" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
