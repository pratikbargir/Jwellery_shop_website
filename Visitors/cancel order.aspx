<%@ Page Language="C#" MasterPageFile="~/Visitors/Usermaster.master" AutoEventWireup="true" CodeFile="cancel order.aspx.cs" Inherits="Visitors_cancel_order" Title="Untitled Page" %>
        ...
        <tr>
            <td style="text-align: center">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    AutoGenerateDeleteButton="True" BorderColor="#999999" BorderStyle="Solid" 
