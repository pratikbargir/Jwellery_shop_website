<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="Diamond Necklace.aspx.cs" Inherits="USER_Diamond_Necklace" Title="Untitled Page" %>
    ...
    <table align="center" cellpadding="3" cellspacing="4" class="style6">
        <tr>
            <td colspan="2">
                ...
                ImageUrl="~/images/necklace/Diamond-Necklace_9.jpg" Width="100%" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <asp:Label ID="lblring" runat="server" Text="Necklace" Visible="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="text-align: center">
                ...
                SelectCommand="SELECT * FROM [Product] WHERE (([pcategorey] LIKE '%' + ? + '%') AND ([psubcat] = ?))">
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="lblring" DefaultValue="Necklace" Name="psubcat" 
