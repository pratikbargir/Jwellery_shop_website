<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="Gold Necklace.aspx.cs" Inherits="USER_Gold_Necklace" Title="Untitled Page" %>
    ...
    <table align="center" cellpadding="3" cellspacing="4" class="style6">
        <tr>
            <td colspan="2">
                ...
                ImageUrl="~/images/necklace/necklace.png" Width="100%" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
