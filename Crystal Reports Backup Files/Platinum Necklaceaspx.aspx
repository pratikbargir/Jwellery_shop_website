<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="Platinum Necklaceaspx.aspx.cs" Inherits="USER_Platinum_Necklaceaspx" Title="Untitled Page" %>
    ...
    <tr>
        <td colspan="2">
            <asp:Image ID="Image1" runat="server" Height="150px" 
                ImageUrl="~/images/necklace/necklace_5.jpg" Width="100%" />
        </td>
    </tr>
    <tr>
        <td colspan="2">
