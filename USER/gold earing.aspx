<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="gold earing.aspx.cs" Inherits="USER_gold_earing" Title="Untitled Page" %>
    ...
    <tr>
        <td colspan="2">
            <asp:Image ID="Image1" runat="server" Height="150px" 
                ImageUrl="~/images/gold earing/earrings.png" Width="100%" />
        </td>
    </tr>
    <tr>
        <td colspan="2">
    ...
    <tr>
        <td colspan="2" style="text-align: center">
            ...
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="Gold" Name="pcategorey" Type="String" />
