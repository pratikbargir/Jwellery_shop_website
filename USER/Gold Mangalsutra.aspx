<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="Gold Mangalsutra.aspx.cs" Inherits="USER_Gold_Mangalsutra" Title="Untitled Page" %>
    ...
    <table align="center" cellpadding="3" cellspacing="4" class="style6">
        <tr>
            <td colspan="2">
                ...
                ImageUrl="~/images/mangalsutra/mangalsutra.png" Width="100%" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
