<%@ Page Language="C#" MasterPageFile="~/USER/Homemaster.master" AutoEventWireup="true" CodeFile="Diamond earings.aspx.cs" Inherits="USER_Diamond_earings" Title="Untitled Page" %>
    ...
    <table align="center" cellpadding="3" cellspacing="4" class="style6">
        <tr>
            <td colspan="2">
                ...
                ImageUrl="~/images/dia earing/earring-1.jpg" Width="100%" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <asp:Label ID="lblring" runat="server" Text="Earrings" Visible="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="text-align: center">
                ...
                SelectCommand="SELECT * FROM [Product] WHERE (([pcategorey] LIKE '%' + ? + '%') AND ([psubcat] = ?))">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="Diamond" Name="pcategorey" Type="String" />
                        <asp:ControlParameter ControlID="lblring" DefaultValue="Earrings" 
                        Name="psubcat" PropertyName="Text" Type="String" />
                    </SelectParameters>
